  ...
  return (
    <div className="container">
      ...
      <div>
        <div className="row mt-3">
          <div className="col-md-12 text-justify">
            <p>Having established ourselves as conscientious and responsible breeders, we take great pride in our affiliation with esteemed organizations dedicated to upholding the highest standards of canine welfare. Our kennel is registered with the 
              <a href="https://www.fci.be/" className="link" target="_blank" rel="noreferrer"> International Canine Federation (FCI)</a> and proudly associated with the 
              <a href="https://www.ikc.ie/" className="link" target="_blank" rel="noreferrer"> Irish Kennel Club (IKC)</a>, adhering to their strict guidelines and regulations. On a personal level, my commitment extends beyond the confines of our kennel. As a dedicated committee member of the 
              <a href="https://www.berneseclubireland.com/" className="link" target="_blank" rel="noreferrer"> Bernese Mountain Dog Club of Ireland</a>, I am privileged to contribute to the promotion and preservation of this beloved breed within our local community. Furthermore, I am honored to serve as the Irish and Baltic representative for the Berner-Garde Foundation, which is a global organization focused on enabling scientific research and providing resources to reduce the spread of genetic diseases and to increase the longevity of our beloved breed.
            </p>
            <p>In conclusion, our journey is guided by a profound love and respect for the Bernese breed, ensuring that every puppy departing the Emerladswiss kennel continues to receive the love, attention, and support they deserve. We invite you to embark together with us on this enchanting journey, full of love, happiness, and commitment to these wonderful dogs, who in turn will bring laughter, devotion, friendship, and lifetime memories in the hearts and homes of their loving families. Please meet our dogs below.
            </p>
          </div>
        </div>
      </div>
      ...
      <div>   
        <NavigationButton to="/ourdogs" buttonText="Our Dogs" variant="success" />
      </div>
