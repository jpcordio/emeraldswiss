    ...
    return (
        <div className="text-justify">
                        ...
                        <div className="card mt-5">
                            <div className="card-body">
                                ...
                                <div className="col-12 text-center mt-3">
                                    <NavigationButton to="/about" buttonText="About Us" variant="success" />
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="container" id="contentOurFamily">
                <div className="row mt-5">
                    ...
                    {[OurFamily1, OurFamily2, OurFamily3].map((src, index) => (
                        <div key={index} className="col-12 col-lg-4 mb-3">
                            <div className="card mx-auto dogFace">
                                <img className="card-img-top" src={src} alt={`Dog's Face ${index + 1}`} />
                                <div className="card-body">
                ...
                <div className="col-12 text-center mt-3">   
                    <NavigationButton to="/ourdogs" buttonText="Meet Us" variant="success" />
                </div>
            </div>
